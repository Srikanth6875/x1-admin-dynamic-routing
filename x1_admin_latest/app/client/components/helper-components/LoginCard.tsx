    ...
    <div className="max-w-md w-full">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200 space-y-8">
        <header className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2 tracking-tight">X1-Admin</h2>
        ...
        <Form method="post" className="space-y-3">
          ...
          <button
            type="submit"
            className="w-full cursor-pointer bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 px-4 rounded-xl shadow-lg"
          >
            Sign In
          </button>
        </Form>
