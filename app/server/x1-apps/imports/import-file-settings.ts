...
export const IMPORT_JOB_COLUMNS_CONFIG: ColumnMetadata[] = [
    ...
    { key: "ij_file_size", label: "File Size (MB)", type: "number" },
    { key: "ij_duration_time", label: "Duration", type: "number" },
    { key: "ij_start_time", label: "Start Time", type: "string" },
    { key: "ij_end_time", label: "End Time", type: "string" },
    { key: "ij_error_message", label: "Error Message", type: "string"},
];
...
export const IMPORT_FILE_JOB_COLUMNS_CONFIG: ColumnMetadata[] = [
    ...
    { key: "ifj_error_message", label: "Error Message", type: "string", width: 100},
